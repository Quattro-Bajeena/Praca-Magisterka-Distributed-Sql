...
[SqlTest(SqlFeatureCategory.Transactions, "Test READ UNCOMMITTED allows dirty reads")]
public class ReadUncommittedDirtyReadTest : SqlTest
{
    ...
    protected override void ExecutePg(DbConnection connection, DbConnection connectionSecond)
    {
        ...
        cmd1.CommandText = "SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED";
        cmd1.ExecuteNonQuery();
        ...
        cmd1.CommandText = "SELECT value FROM ru_dirty WHERE id = 1";
        object? dirtyRead = cmd1.ExecuteScalar();
        AssertEqual(100, Convert.ToInt32(dirtyRead!), "PostgreSQL READ UNCOMMITTED behaves like READ COMMITTED");
        ...
        cmd1.CommandText = "SELECT value FROM ru_dirty WHERE id = 1";
        object? afterRollback = cmd1.ExecuteScalar();
        AssertEqual(100, Convert.ToInt32(afterRollback!), "Should see original value");
